...
//   static async getBusinessOrders(req: EmployeeAuthRequest, res: Response, next: NextFunction) {
//     try {
//       if (!req.employee) {
...
//             status_name: this.getStatusName(currentStatus.status),
//             timestamp: currentStatus.log_timestamp,
//             isCanceled: currentStatus.isCanceled
//           } : {
//             status: 1,
//             status_name: this.getStatusName(1),
